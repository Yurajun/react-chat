...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _componentsRooms = __webpack_require__(160);

	var _componentsRooms2 = _interopRequireDefault(_componentsRooms);

	var _componentsChat = __webpack_require__(161);

	var _componentsChat2 = _interopRequireDefault(_componentsChat);

	var _componentsLogin = __webpack_require__(162);
	...
	var App = (function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.server.onMessage = function (f, c, m) {
	        return _this.handleMessage(f, c, m);
	      };
	      this.server.onListChats = function (l) {
	        return _this.handleList(l);
	      };
	    }
	  }, {
	    key: 'login',
	    ...
	    value: function selectRoom(room) {
	      ...
	      this.server.getLog(room, function (messages) {
	        return _this2.setState({ messages: messages });
	      });
	    }
	  }, {
	    key: 'handleList',
	    value: function handleList(rooms) {
	    ...
	    key: 'handleMessage',
	    value: function handleMessage(from, room, msg) {
	    ...
	    value: function render() {
	      ...
	      if (this.state.userName == null) return _react2['default'].createElement(_componentsLogin2['default'], { onLogin: function (n) {
	          return _this3.login(n);
	        } });

	      return _react2['default'].createElement(
	        'div',
	        { id: 'app' },
	        _react2['default'].createElement(_componentsRooms2['default'], { room: this.state.room,
	          items: this.state.rooms,
	          onSelect: function (r) {
	            return _this3.selectRoom(r);
	          } }),
	        _react2['default'].createElement(_componentsChat2['default'], { items: this.state.messages,
	          user: this.state.userName,
	          onSend: function (m) {
	            return _this3.send(m);
	          },
	          onLogout: function () {
	            return _this3.login(null);
	          } })
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports['default'] = function (props) {
	  return _react2['default'].createElement(
	    'div',
	    { style: { float: 'right', width: 200, cursor: 'pointer' } },
	    'Список комнат:',
	    _react2['default'].createElement(
	      'ul',
	      null,
	      props.items.map(function (name) {
	        if (name == props.room) return _react2['default'].createElement(
	          'li',
	          null,
	          _react2['default'].createElement(
	            'b',
	  ...
	  _createClass(Chat, [{
	    ...
	    value: function renderMsgBox() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement('input', { id: 'chatmsg', type: 'text' }),
	        _react2['default'].createElement(
	          'button',
	          { onClick: function () {
	              return _this.send();
	...
	exports["default"] = function (props) {
	  return _react2["default"].createElement(
	    ...
	    _react2["default"].createElement(
	      "button",
	      { onClick: function () {
	          return props.onLogin(document.getElementById('login').value);
	        } },
	      "Войти"
	    )
	  );
...
/***/ (function(module, exports) {
	...
	var Server = (function () {
	  function Server() {
	    ...
	    this.server.on('new', function (m) {
	      return _this.onMessage(m.from, m.room, m.msg);
	    });
	    this.server.on('log', function (l) {
	      return _this.onLog(l);
	    });
	    this.server.on('list', function (m) {
	      return _this.onListChats(m);
	    });
	  ...
	  _createClass(Server, [{
	    key: 'send',
	    value: function send(from, room, msg) {
	      this.server.emit('msg', { from: from, room: room, msg: msg });
	    }
	  }, {
	    key: 'onMessage',
	    value: function onMessage(from, room, msg) {
	      console.log('Server: Пришло сообщение а какое не скажу');
	    }
	  }, {
	    key: 'getLog',
	    value: function getLog(room, cb) {
	    ...
	    value: function onLog(log) {
	      ...
	      if (this.logcb) this.logcb(log);
	    }
	  }, {
	    key: 'onListChats',
	    value: function onListChats(list) {}
	  }]);
